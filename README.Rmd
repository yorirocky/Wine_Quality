...
```{r histogram-Of-both-Wines, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
# Basic structure
glimpse(winesData)
...
```{r complete-Correlation-Plot, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
...
```{r singlr-Correlation-Plot, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
...
```{r box-plot-of-Wine-Data, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
#Boxplot
...
```{r correlation-quality-alcohol, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
...
```{r linear-model, echo = FALSE, fig.path="figures/", fig.align='center'}
# Build models
...
```{r linear-regression-line, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
...
### Q-Q plots
```{r Q-Q-plots, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
...
```{r histogram-of-residuals, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
...
```{r homoscedasticity, echo = FALSE, message = FALSE, fig.path="figures/", fig.align='center'}
